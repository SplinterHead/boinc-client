...
from boinc_client.models.old_results import OldResultList
from boinc_client.models.result import ResultList
...
def results(client: RpcClient, active_only: bool = False) -> dict:
    ...
    return ResultList().load(rpc_json)
...
def old_results(client: RpcClient) -> dict:
    ...
    return OldResultList().load(rpc_json)
